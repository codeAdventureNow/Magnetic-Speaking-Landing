...
(function () {
  ...
  var _removed = false;
  var form_to_submit = document.getElementById("_form_1222_");
  ...
  var form_submit = function (e) {
    ...
    if (validate_form()) {
      ...
      document.querySelector("#_form_1222_submit").disabled = true;
      var serialized = _form_serialize(
        document.getElementById("_form_1222_")
      ).replace(/%0A/g, "\\n");
      var err = form_to_submit.querySelector("._form_error");
      err ? err.parentNode.removeChild(err) : false;
      _load_script(
        "https://magneticspeaking.activehosted.com/proc.php?" +
          serialized +
          "&jsonp=true"
      );
    }
